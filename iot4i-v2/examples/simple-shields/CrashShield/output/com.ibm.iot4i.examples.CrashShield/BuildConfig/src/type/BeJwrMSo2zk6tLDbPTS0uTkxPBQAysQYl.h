...
#ifndef BEJWRMSO2ZK6TLDBPTS0UTKXPBQAYSQYL_H_
#define BEJWRMSO2ZK6TLDBPTS0UTKXPBQAYSQYL_H_
...
#define SELF BeJwrMSo2zk6tLDbPTS0uTkxPBQAysQYl
...
public:
    ...
    SELF() : Tuple(), key_(), message_() {}
    SELF(const Self & ot) : Tuple(), key_(ot.key_), message_(ot.message_) 
      { constructPayload(ot); }
    SELF(const key_type & _key, const message_type & _message) : Tuple(), key_(_key), message_(_message) { }
...
#undef SELF
#endif // BEJWRMSO2ZK6TLDBPTS0UTKXPBQAYSQYL_H_ 
