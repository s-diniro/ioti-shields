// t3s5topics3keys7message


#ifndef BEJWRMS42LCKVYEWUNS5ORSW2Z00TLK5MTWUAASIIDT_H_
#define BEJWRMS42LCKVYEWUNS5ORSW2Z00TLK5MTWUAASIIDT_H_
...
#define SELF BeJwrMS42LckvyEwuNs5OrSw2z00tLk5MTwUAaSIIDt
...
public:
    ...
    SELF() : Tuple(), topic_(), key_(), message_() {}
    SELF(const Self & ot) : Tuple(), topic_(ot.topic_), key_(ot.key_), message_(ot.message_) 
      { constructPayload(ot); }
    SELF(const topic_type & _topic, const key_type & _key, const message_type & _message) : Tuple(), topic_(_topic), key_(_key), message_(_message) { }
...
#undef SELF
#endif // BEJWRMS42LCKVYEWUNS5ORSW2Z00TLK5MTWUAASIIDT_H_ 
