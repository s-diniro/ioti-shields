package com.ibm.iot4i.enocean.panicbuttonshield;
...
public class CheckPanicButtonPressedImpl {

	static Logger logger = Logger.getLogger(CheckPanicButtonPressedImpl.class);

	@Function(namespace = "com.ibm.iot4i.enocean.panicbuttonshield", name = "checkPanicButtonPressed", description = "", stateful = false)
